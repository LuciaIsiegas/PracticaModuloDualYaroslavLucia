...
public class Principal {
	...
	public static void main(String[] args) {
		...
		try {
			...
			int opcion = 0;
			do {
				opcion = Metodos.getInt(sc, "Base Activa: " +
						(baseActiva.equals("") ? "'null'" : baseActiva)
						+ "\n" + Metodos. MENU + "\nTu opcion: ");
				...
				case 4:
					String opcion4 = "\nMostrar datos de:\n";
					Metodos.mostrarDatos(conexion, Metodos.mostrar1Tabla(sc, opcion4));
					break;
				case 5:
					String opcion5 = "\nMostrar datos de:\n";
					Metodos.mostrarDatos(conexion, Metodos.mostrar2Tablas(sc, opcion5));
					break;
				case 6:
